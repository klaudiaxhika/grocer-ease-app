...
import { ShoppingCart, CalendarDays, BookOpen, CheckCircle } from 'lucide-react';
...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon, title, description, link }) => {
  return (
    <div className="bg-white rounded-lg overflow-hidden border h-full transition-all hover:shadow-md">
